...
public class OrderController {
    ...
    public ResponseEntity<Object> doOder(@RequestBody @Valid CreateOderRequest listProduct){
    ...
    public ResponseEntity<Object> getOrderDetailByOrderId(@PathVariable("id") int orderId){
        User user = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        com.banxedap.cdio3.Entities.User userOrder = userService.getUserByUserName(user.getUsername());
